 ...
 */
namespace CleverSoft\CleverBrands\Controller\Adminhtml\Wysiwyg\Images;
...
class OnInsert extends \Magento\Cms\Controller\Adminhtml\Wysiwyg\Images
{
    ...
    {
        $helper = $this->_objectManager->get('CleverSoft\CleverBrands\Helper\Wysiwyg\Images');
        ...
        //$image = $helper->getImageHtmlDeclaration($filename, $asIs);
        $image['short'] = $helper->getImageRelativeUrl($filename);
