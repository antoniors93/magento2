<?php
namespace CleverSoft\MegaMenus\Block\Adminhtml\Formfields\NewAction\Edit;
	...
	protected function _prepareForm()
    {
		...
		$fieldset->addField(
			...
			[
				...
				'options' => ['show' => 'Normal', 'fade' => __('Fade'),'slide' => __('Slide')],
				'required' => false
			]
		);
		...
		$renderer = $this->getLayout()->createBlock(
			'CleverSoft\MegaMenus\Block\Adminhtml\Formfields\NewAction\Fields\MenuItems'
		);
