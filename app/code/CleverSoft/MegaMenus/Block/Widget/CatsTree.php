 ...
 */
class CatsTree extends Template implements IdentityInterface
{
    /**
     * Cache identities
     *
    ...
    public function __construct(
		...
		\CleverSoft\MegaMenus\Helper\Category $catalogCategory,
    ...
    public function getHtml($outermostClass = '', $childrenWrapClass = '', $limit = 0)
    {
		...
		$this->_addCategoriesToMenu($this->catalogCategory->getCategoriesByParentId($parentId,false,true), $this->_menu, $this);
