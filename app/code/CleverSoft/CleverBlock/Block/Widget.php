        ...
        switch ($name){
            case 'countdown':
                return $this->_jsonEncoder->encode(array(
                    ...
                    'engineSrc'         => $this->getViewFileUrl('CleverSoft_CleverBlock::js/jquery.jcountdown.min.js')
                ));
                break;
            case 'kenburns':
                return $this->_jsonEncoder->encode(array(
...
//                    'images'    => $this->_getKenburnsImages(),
                    ...
                    'engineSrc' => $this->getViewFileUrl('CleverSoft_CleverBlock::js/kenburns.js')
                ));
                break;
            case 'parallax':
                return $this->_jsonEncoder->encode(array(
            ...
            case 'carousel':
                return $this->_jsonEncoder->encode(array(
                    ...
                    'engineSrc'     => $this->getViewFileUrl('CleverSoft_Base::js/owl.carousel.js')
                ));
                break;
            case 'animation':
                return $this->_jsonEncoder->encode(array(
