/**
 * @category    MT
 * @package     CleverSoft_CleverBlock
...
define([
    ...
    var CleverSoftBlock = CleverSoftBlock || {};
    CleverSoftBlock.Widget = Class.create();
    CleverSoftBlock.Widget.prototype = {
            ...
            this.container.select('.widget-tabs a').each(function(tab){
                ...
                Event.observe(tab, 'click', function(e){
                    ...
                    var a = Event.findElement(e, 'a'),
                        ...
                        form_key = CleverSoftBlock['FORM_KEY'] || null;
                ...
                if(config.lazyload) {
                    if(!jQuery.fn.lazyload) {
                        jQuery.getScript(config.lazyEngineSrc).done(function( script, textStatus ) {
                                ...
                                console.log( "Triggered lazy.doLazyload handler." );
                            });
                    } else {
                        lazy.doLazyload(div);
                    }
