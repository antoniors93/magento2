...
namespace CleverSoft\CleverCategory\Block\Adminhtml\Widget\Renderer;

use CleverSoft\CleverProduct\Model\Widget\Source\Tab\Mode;
...
class Category extends Template implements RendererInterface {
    ...
    public function getCategoriesChooserUrl(){
        return $this->getUrl('cleverproduct/widget/categories', ['_current' => true]);
    }
