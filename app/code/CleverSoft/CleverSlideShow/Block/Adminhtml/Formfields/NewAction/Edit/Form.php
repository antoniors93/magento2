<?php
namespace CleverSoft\CleverSlideShow\Block\Adminhtml\Formfields\NewAction\Edit;
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \CleverSoft\CleverSlideShow\Model\LayoutFactory $layoutType,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $renderer = $this->getLayout()->createBlock(
            'CleverSoft\CleverSlideShow\Block\Adminhtml\Formfields\NewAction\Fields\SliderItems'
        );
