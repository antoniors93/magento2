<?php
namespace CleverSoft\CleverSlideShow\Block\Adminhtml\Formfields\NewAction\Fields\SliderItems;
...
class Types extends \Magento\Backend\Block\Template
{
    ...
    public function getImageUrl($path){
        return $this->_assetRepo->getUrl('CleverSoft_CleverSlideShow/images/'.$path);
    }
}
?>