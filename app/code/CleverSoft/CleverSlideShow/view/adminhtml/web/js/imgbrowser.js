...
define([
    ...
    cleverMediabrowserUtilitySlideShow = {
        windowId: 'modal_dialog_message_slideshow',
		modal: false,
    ...
    $.widget("custom.cleverMediabrowser", {
        eventPrefix: "cleverMediabrowser",
        options: {
        ...
        insert: function(event) {
            ...
            if (!targetEl.length) {
                cleverMediabrowserUtilitySlideShow.closeDialog();
            ...
            return $.ajax({
                ...
                if (targetEl.is('textarea')) {
                    ...
                    targetEl.append('<input type="hidden" id="clever-temporary-images" value="'+data.full+'" >');
	...
	return $.custom.cleverMediabrowser;
});