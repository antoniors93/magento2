...
class Data extends \Magento\Framework\App\Helper\AbstractHelper{
    ...
    /**
     * @var \CleverSoft\Base\Helper\Image
     */
    ...
    public function __construct(
        ...
        \CleverSoft\Base\Helper\Image $imageHelper,
    ...
    {
        if ($storeId)
            return $this->scopeConfig->getValue('cleversoftbase_design', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId);
        else
            return $this->scopeConfig->getValue('cleversoftbase_design',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
    /**
    ...
    {
        return $this->scopeConfig->getValue('cleversoftbase_design/' . $optionString, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $scopeCode);
    }
    /**
    ...
    public function getAltImgHtml($product, $w, $h, $imgVersion='small_image')
    {
        ...
        if(isset($galleryImages[($value-1)]))
            $html =
                '<img class="img-responsive alt-img" src="' . $galleryImages[($value-1)] . '" alt="' . $product->getName() . '" width="auto" height="auto"/>';
        else
            $html = '';
        return $html;
    }
