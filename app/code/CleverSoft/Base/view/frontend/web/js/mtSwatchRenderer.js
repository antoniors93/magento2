...
define([
     ...
     */
    $.widget('mage.mtswatchRendererTooltip', {
        options: {
    ...
    $.widget('mage.mtswatchRenderer', {
        ...
        _init: function () {
            if (this.options.jsonConfig !== '' && this.options.jsonSwatchConfig !== '') {
                ...
                console.log('mtswatchRenderer: No input data received');
            }
        },
        ...
        _OnClick: function ($this, $widget) {
            ...
            var a = $widget.element.parents($widget.options.selectorProduct);
            var c = $widget.element.parents($widget.options.selectorProduct).find(this.options.selectorProductPrice);
            var b = $widget.element.parents($widget.options.selectorProduct).find(this.options.selectorProductPrice).is(':data(mage-priceBox)');
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (isProductViewExist) {
                ...
                context.find('.product-image-photo').attr('src',justAnImage.finalImg).attr('data-src',justAnImage.finalImg);
            }
        },
