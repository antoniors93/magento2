...
class lessc {
     ...
     * @param array $functions Functions to register into the created Less instance
     * @return array lessphp cache structure
     */
    public static function cexecute($in, $force = false, $initial_variables = null, $functions = null) {
        ...
        if ($root !== null) {
            ...
            if (is_array($functions)) {
                foreach ($functions as $name => $function) {
                    if (is_callable($function)) {
                        $less->registerFunction($name, $function);
                    }
                }
            }
            ...
            $out = array();
            $out['root'] = $root;
            $out['compiled'] = $less->parse(null, $initial_variables);
