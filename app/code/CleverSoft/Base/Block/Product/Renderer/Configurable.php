 ...
 */
namespace CleverSoft\Base\Block\Product\Renderer;
...
class Configurable extends \Magento\Swatches\Block\Product\Renderer\Listing\Configurable
{
    ...
    public function __construct(
        ...
        \CleverSoft\Base\Helper\Data $helperData,
        array $data = []
    ) {
    ...
    public function getJsonConfig()
    {
        ...
        $showSize = $this->matoHelper->getCfg('category_grid/display_size');
        $showColor = $this->matoHelper->getCfg('category_grid/display_color');
        $attributes = [];
        foreach($attributesData['attributes'] as $key => $att)
        {
            $att['extClass'] = '';
            if($showSize == 'remove' && $att['code'] == 'size') continue;
            if($showColor == 'remove' && $att['code'] == 'color') continue;

            if($showSize == 'hover' && $att['code'] == 'size') $att['extClass'] = ' hover';
            if($showColor == 'hover' && $att['code'] == 'color') $att['extClass'] = ' hover';
