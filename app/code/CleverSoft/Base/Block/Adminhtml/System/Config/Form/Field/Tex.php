...
//use CleverSoft\Base\Helper\Design as HelperDesign;
...
class Tex extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $initialTexUrl = $this->_assetRepo->getUrlWithParams(
            ...
            ['area' => 'frontend', 'theme' => 'CleverSoft/core']
        );
        ...
        $html .= '<br/>
        <div id="'. $previewId .'" style="height:160px; margin:10px 0; background-color:transparent;" title="'. $element->getEscapedValue() .'"></div>
