...
class FilterSetting extends \Magento\Framework\Model\AbstractModel implements FilterSettingInterface, IdentityInterface
{
    ...
    {
        return ($this->getDisplayMode() == DisplayMode::MODE_DEFAULT) || ($this->getDisplayMode() == DisplayMode::MODE_IMG_LABEL)
        || ($this->getDisplayMode() == DisplayMode::MODE_IMAGE) || ($this->getDisplayMode() == DisplayMode::MODE_TEXTSWATCHES) || ($this->getDisplayMode() == DisplayMode::MODE_DROPDOWN);
    }
}
