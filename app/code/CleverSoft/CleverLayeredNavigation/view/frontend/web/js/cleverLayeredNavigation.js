 ...
 * @copyright Copyright (c) CleverSoft Ltd. ( http://www.cleversoft.com/ )
 * @package   CleverSoft_LayeredNavigation
 */
define([
    "jquery",
    "jquery/ui",
            ...
            $(function(){
                ...
                $slider.slider({
                    ...
                    slide: function( event, ui ) {
                        $( "#" + elementID + "_display" ).html( " <span> " + self.renderLabel(ui.values[ 0 ]) + " </span><span> " + self.renderLabel(ui.values[ 1 ]) + " </span> ");
                    },
